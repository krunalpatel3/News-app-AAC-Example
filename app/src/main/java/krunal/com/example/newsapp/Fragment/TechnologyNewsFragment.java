...
import krunal.com.example.newsapp.ViewModel.TechnologyNewsViewModel;


public class TechnologyNewsFragment extends Fragment {

    private TechnologyNewsViewModel mTechnologyNewsViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mTechnologyNewsViewModel = ViewModelProviders.of(this).get(TechnologyNewsViewModel.class);
    ...
    private void Refresh(){
        if (Utility.CheckInternetConnection(getContext())) {
            mTechnologyNewsViewModel.getNews().observe(this, new Observer<List<News>>() {
                @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.technologynews_fragment, container, false);

        mSwipeRefreshLayout = view.findViewById(R.id.swipe_refresh);
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewTechnologyNews);
