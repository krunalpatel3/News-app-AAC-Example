...
import krunal.com.example.newsapp.ViewModel.SportsNewsViewModel;

public class SportsNewsFragment extends Fragment {

    private SportsNewsViewModel mSportsNewsViewlModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mSportsNewsViewlModel = ViewModelProviders.of(this).get(SportsNewsViewModel.class);
    ...
    private void Refresh(){
        if (Utility.CheckInternetConnection(getContext())) {
            mSportsNewsViewlModel.getNews().observe(this, new Observer<List<News>>() {
                @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewSports);
